...
-- Auto-generated by thinkup/extras/scripts/migratedb script on 2011-06-24
--
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Hashtags captured per post in the datastore. Multiple hashta';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Mentions captured per user in the data store. One row per us';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Mentions captured per post in the data store. Multiple menti';
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Places posts were published from on a given network. One row';
...
-- Dump completed on 2011-06-24 11:33:50
