...
<div class="container_24">
  ...
  <div role="application" id="tabs">
   ...
   <div class="prepend_20">
    ...
    <p><br />
    <a href="{$site_root_path}install/backup.php">Back up BigData's entire database</a> (highly recommended before upgrading BigData)<br /><br />
    <a href="{$site_root_path}install/exportuserdata.php">Export a single service user's data</a> (for transfer into another existing Bigdata database)
    </p>
  </div>
...
<p>
External applications use your BigData API key for authentication. For example, 
RSS news readers can update your BigData
...
<a href="http://thinkupapp.com/docs/userguide/settings/account.html">Learn more.</a><br /><br />
          ...
          <div style="text-align: center; border-top: solid gray 1px; padding: 20px 0px 20px 0px;">
             <strong>Your Current BigData API Key:</strong>
      ...
      <div class="grid_10 prefix_9 left">
                ...
                Don't forget! If you reset your API key, you will need to update your bigdata crawler RSS feed subscription. This action cannot be undone.
                </span>
